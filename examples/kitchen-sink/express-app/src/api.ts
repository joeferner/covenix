...
// One configured Covenix instance, shared by the server (main.ts) and the headless
...
export const api = new Covenix({ info: apiInfo, security: buildSecurity(authService) });
